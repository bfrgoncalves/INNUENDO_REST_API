...
class Job_queue(Resource):
	...
	def get(self):
		...
		request = requests.get(JOBS_ROOT, params={'job_id':args.job_id, 'username':str(current_user.username), 'pipeline_id':args.pipeline_id, 'project_id':args.project_id, 'process_id':args.process_id})
