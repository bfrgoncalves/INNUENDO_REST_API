	        ...
	        "initComplete": function() {
				    ...
				    for(j in CURRENT_TABLE_ROW_ANALYSIS_SELECTED[table_id]){
				    	if($.inArray(CURRENT_TABLE_ROW_ANALYSIS_SELECTED[table_id][j], already_added) == -1){
				    		console.log("AQUI", CURRENT_TABLE_ROW_ANALYSIS_SELECTED[table_id][j], $('#'+table_id+' tbody tr').eq(CURRENT_TABLE_ROW_ANALYSIS_SELECTED[table_id][j] + count_clicked), CURRENT_TABLE_ROW_ANALYSIS_SELECTED[table_id][j] + count_clicked);
