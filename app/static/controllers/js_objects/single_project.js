			...
			pg_requests.get_job_status(job_ids, procedure_names, strain_id, pipeline_id, process_positions, project_to_search, process_ids, function(response, this_job_id){
				...
				if(response.data != false){
					...
					for(n in response.data){
						...
						console.log(strain_id, process_id_to_workflow[strain_id + String(counter_processes+1)], prev_workflow, process_id_to_workflow, process_id_to_workflow[strain_id + counter_processes+1], response.data.length - 1, n);
