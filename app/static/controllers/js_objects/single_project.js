		...
		apply_workflow: function(mode, type_proc, callback){
		    ...
		    for(i in strain_data){
		        ...
		        if(mode == 'new'){
		        	...
		        	if(pip_start_id > 0){
		        		pipelines_type_by_strain[strain_data[counter-1]['strainID']][1][pip_start_id] = pipelines_type_by_strain[strain_data[counter-1]['strainID']][1][pip_start_id].replace(class_of_button_remove_to_replace, 'style="display:none;" ' + class_of_button_remove_to_replace)
		        		console.log(pipelines_type_by_strain[strain_data[counter-1]['strainID']][1][pip_start_id]);
		        	}
