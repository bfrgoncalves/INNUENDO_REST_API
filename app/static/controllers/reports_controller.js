						...
						if(current_project != ""){
							...
							pg_requests.get_applied_pipelines(null, current_project, function(response){
								...
								reports.get_project_reports(current_project, pipelines_to_check, function(response){
									...
									objects_utils.restore_table_headers('reports_info_table', reports_info_table_headers, function(){
										objects_utils.restore_table_headers('reports_results_table', reports_info_table_headers, function(){
	...
	function show_strains_metadata(strain_names){
		...
		reports.get_strain_by_name(to_use, function(strain_data){
			...
			if(current_strains_data.length != 0){
				...
				objects_utils.restore_table_headers('reports_metadata_table', reports_metadata_table_headers, function(){
						...
						setTimeout(function(){
							for(p in q){
								...
								$('#run_info_' + q[p]).on('click', function(){
									...
									objects_utils.restore_table_headers('reports_info_table', reports_info_table_headers, function(){
										objects_utils.restore_table_headers('reports_results_table', reports_results_table_headers, function(){
